# DEBUG RA VBlank C0 hook — TROPHY BADGE (white box + black rounded border +
# yellow trophy), top-left, double-buffered. Counter-gated (0x2FF8 bit6).
#
# 32x32 badge drawn in 3 layers into BOTH current and previous VI_TFBL
# (scratch 0xC0002FF4) to beat double buffering. draw_badge is a subroutine
# called twice; the codehandler return LR is saved to 0xC0002FF0 first.
# Touch ONLY r3/r5/r9/r10/r11/r12 (r3 free inside draw_badge; r9 holds prev).
#
# Geometry (16 u32-cols x 32 rows, 1 u32-col = 2px). Badge top-left =
# row 24 * 1280 + col 20(u32) * 4 = 0x7850.
#   BLACK outline (rounded): rows0-1 c1-14 ; rows2-29 c0-15 ; rows30-31 c1-14
#   WHITE interior (inset 2px): rows2-3 c2-13 ; rows4-27 c1-14 ; rows28-29 c2-13
#   YELLOW trophy (rows5-26, inset 1 row from white):
#     rim r5-7 c3-12 ; bowl r8-14 c4-11 ; taper r15-16 c6-9 ;
#     stem r17-21 c7-8 ; plate r22-23 c6-9 ; foot r24-26 c4-11
    .globl _start
_start:
    lis    12, 0xC000
    lwz    3, 0x2FF8(12)
    ...
    andi.  9, 3, 0x40           # gate: counter bit 6
    beq    done
